# routes/tickets.py - Ticket routes for Customer Support Ticketing System
# Author: Pavan (Intern)
# Date: 2025-10-10
# Description: Handles creation, viewing, updating, and deletion of support tickets.
...
def update_ticket(ticket_id):
    ...
    # Admin can update all fields, users can only update their own tickets' basic info
    if current_user.is_admin:
        ...
        # Regular users can only update their own tickets' basic info (before closed)
        ...
        # Users can update basic ticket info
        if 'title' in data:
            ticket.title = data['title']
        if 'description' in data:
            ticket.description = data['description']
